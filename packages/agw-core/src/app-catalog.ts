...
export const skillCatalog: readonly AgwSkillRef[] = [
  {
    ...
    description:
      "Bootstrap, inspect, and revoke AGW sessions using explicit approval and narrow field selection.",
  ...
  },
  {
    ...
    description:
      "Use wallet and session reads with field trimming and pagination to stay within agent context budgets.",
  ...
  },
  {
    ...
    description:
      "Preview-first rules for signing, sends, transfers, contract writes, and deployments.",
  ...
  },
  {
    ...
    description:
      "Find apps, streams, and user profiles through Portal with response shaping for agent-safe reads.",
  ...
  },
  {
    ...
    description:
      "Compose AGW core commands for Aborean Finance workflows without baking protocol logic into the CLI core.",
  ...
  },
  {
    ...
    description:
      "Compose AGW contract commands for Uniswap V2 and V3 swaps, quotes, and liquidity on Abstract.",
  ...
  },
  {
    ...
    description:
      "Register, inspect, and manage AI agent identity and reputation on Abstract via ERC-8004.",
  ...
  },
  {
    ...
    description:
      "Guide users through bridging assets to/from Abstract via native bridge or third-party providers.",
  ...
  },
  {
    ...
    description:
      "Build, deploy, and integrate applications on Abstract with Foundry, Hardhat, AGW SDK, and paymasters.",
  ...
  },
  {
    ...
    description:
      "Vote for apps on the Abstract Portal using the on-chain AbstractVoting contract.",
  ...
  },
  {
    ...
    description:
      "Interact with the Bigcoin virtual mining game — facilities, miners, rewards, and hashrate.",
...
export const appCatalog: readonly AgwAppCatalogEntry[] = [
  ...
  },
  {
    ...
    contracts: [
      ...
      {
        address: "0x4d8971D9932C1c0c16079722b3D93893F16Bb065",
        label: "Comptroller",
      },
      {
...
export function listSkillRefs(skillIds: readonly string[]): AgwSkillRef[] {
  return skillIds
    .map((skillId) => getSkillRef(skillId))
    .filter((skill): skill is AgwSkillRef => Boolean(skill));
}

export function getAppCatalogEntry(
  appId: string,
): AgwAppCatalogEntry | undefined {
