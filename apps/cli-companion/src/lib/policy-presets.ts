...
> = {
  payments: {
    ...
    label: "Payments",
    description:
      "Transfer-focused automation with explicit recipient allowlist and short expiry.",
    customMode: false,
    riskHint: "low",
  ...
  trading: {
    ...
    label: "Trading",
    description:
      "Selector-scoped trading calls for selected apps with moderate limits.",
    customMode: false,
    riskHint: "medium",
    requiresDangerAcknowledgement: false,
    defaultLimits: {
  ...
  gaming: {
    ...
    label: "Gaming",
    description:
      "Gameplay-centric app calls with moderate limits and medium-lived sessions.",
    customMode: false,
    riskHint: "medium",
    requiresDangerAcknowledgement: false,
    defaultLimits: {
  ...
  contract_write: {
    ...
    description:
      "Write access to selected contracts/functions without deployment permissions.",
    customMode: false,
    riskHint: "high",
    requiresDangerAcknowledgement: false,
    defaultLimits: {
  ...
  deploy: {
    ...
    label: "Deploy",
    description:
      "Contract deployment workflows with explicit high-risk confirmation.",
    customMode: false,
    riskHint: "critical",
  ...
  signing: {
    ...
    label: "Signing",
    description:
      "Message and transaction signing-focused access with strict warnings.",
    customMode: false,
    riskHint: "high",
    requiresDangerAcknowledgement: true,
    defaultLimits: {
  ...
  full_app_control: {
    ...
    description:
      "Broad device signer access with chain, time, and native value limits.",
    customMode: false,
    riskHint: "critical",
    requiresDangerAcknowledgement: true,
    defaultLimits: {
...
export const POLICY_PRESET_OPTIONS: Array<{
