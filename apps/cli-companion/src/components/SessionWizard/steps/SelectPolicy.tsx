...
const SHIELD_ICON = (
  ...
  >
    <path
      d="M7 1.5L2.5 3.5V6.5C2.5 9.5 4.5 11.5 7 12.5C9.5 11.5 11.5 9.5 11.5 6.5V3.5L7 1.5Z"
      stroke="currentColor"
      strokeWidth="1.25"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const CHAIN_ICON = (
  ...
  >
    <path
      d="M5.5 8.5L8.5 5.5M4.5 6.5L3.5 7.5C2.5 8.5 2.5 10 3.5 10.5C4.5 11.5 6 11.5 6.5 10.5L7.5 9.5M6.5 4.5L7.5 3.5C8.5 2.5 10 2.5 10.5 3.5C11.5 4.5 11.5 6 10.5 6.5L9.5 7.5"
      stroke="currentColor"
      strokeWidth="1.25"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export default function SelectPolicy({
  ...
  const { expiryLabel, maxValueLabel, chainName } = useMemo(() => {
    ...
    const maxValueWei = BigInt(
      preview.policyPayload.sessionConfig.maxValuePerUse,
    );
  ...
  const handleAuthorize = () => {
    if (!dangerAcknowledged) {
      setValidationError(
        "Confirm that you understand the access you are granting.",
      );
      return;
    }
      ...
      <Card className={styles.mainCard}>
        ...
        <CardContent className={styles.mainBody}>
          ...
          <p className={styles.consentSubtext}>
            Allow an AI agent to act on behalf of your wallet within strict
            safety limits.
          </p>

          <div className={styles.safetyPills}>
            <span className={styles.safetyPill}>
              <span className={styles.safetyPillIcon} aria-hidden="true">
                {CLOCK_ICON}
              </span>
          ...
          <div className={styles.permissionBlock}>
            <p className={styles.permissionBlockTitle}>
            ...
            <ul className={styles.permissionListCompact}>
              {AGENT_PERMISSIONS.map((label) => (
                <li key={label} className={styles.permissionListCompactItem}>
                  <span
                    className={styles.permissionCheckIcon}
                    aria-hidden="true"
                  >
                    {CHECK_ICON}
                  </span>
          ...
          <label className={styles.consentAckSimple}>
            ...
            />
            <span>
              I approve this agent to act within these limits. I can revoke
              access at any time.
            </span>
          </label>
        </CardContent>
