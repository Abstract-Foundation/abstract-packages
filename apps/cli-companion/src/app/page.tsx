...
const COMMANDS = {
  ...
  "claude-code": `claude mcp add agw-cli -- npx -y @abstract-foundation/agw-cli mcp serve --json '{"chainId":2741}'`,
  json: `{
  "mcpServers": {
    "agw-cli": {
      "command": "npx",
    ...
    <div className={styles.page}>
      <div className={styles.hero}>
        ...
        <p className={styles.subtitle}>
          Connect your wallet once, then query wallet, chain, and Portal data
          from your AI client.
        </p>
      </div>
        ...
        <section className={styles.section}>
          ...
          <div className={styles.sectionBody}>
            <p className={styles.text}>
              Open your terminal and run this command. It will open a browser
              window where you connect your wallet and approve linking this
              machine.
            </p>
            <div className={styles.codeBlock}>
              ...
              <code className={styles.code}>
                ...
                >{`"{\\"chainId\\":2741,\\"execute\\":true}"`}</span>
              </code>
            </div>
          </div>
          ...
          <div className={styles.sectionBody}>
            <p className={styles.text}>
              Tell your AI client how to find the AGW server. Pick your client
              below:
            </p>
            ...
            {activeClient === "claude-code" && (
              <>
                <p className={styles.text}>Run this in your terminal:</p>
                <div className={styles.codeBlock}>
            ...
            {activeClient === "cursor" && (
              <>
                <p className={styles.text}>
                  Open your editor&#39;s MCP configuration file and add the same
                  JSON block:
                </p>
                <div className={styles.codeBlock}>
                  <CopyButton text={COMMANDS.json} />
                ...
                <p className={styles.text}>
                  Save and restart your editor. The AGW tools will be available
          ...
          <div className={styles.sectionBody}>
            ...
            <div className={styles.codeBlock}>
              <code className={styles.code}>
                ...
                {"\n"}
                <span className={styles.codeString}>
                  &quot;Show my wallet address, ETH balance, and token
                  balances.&quot;
                </span>
                {"\n"}
                {"\n"}
                ...
                {"\n"}
                <span className={styles.codeString}>
                  &quot;Get my account portfolio summary from the Abstract
                  Portal API.&quot;
                </span>
              </code>
            </div>
